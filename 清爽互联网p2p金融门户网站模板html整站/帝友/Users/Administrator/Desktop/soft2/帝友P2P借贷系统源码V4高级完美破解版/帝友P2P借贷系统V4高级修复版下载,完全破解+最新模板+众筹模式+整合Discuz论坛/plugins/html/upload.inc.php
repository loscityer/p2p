...
$fileType=array('doc','rar','xls','ppt','pps','pdf','txt'); 
...
<head> 
        ...
        <title>';if ($s == "uploadimg"){;echo '插入图片';}else{;echo '插入附件 ';};echo '</title>
         <style type="text/css"> 
        ...
        function LoadIMG(imgpath){ 
           oRTE = window.dialogArguments.document.getElementById(\'';echo $_REQUEST['id'];;echo '\');
             if(window.isIE) { 
                try{ 
                    oRTE.value =imgpath; 
                } 
    ...
    <body> 
    ';if ($s == "uploadimg"){;echo '    <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" id="tabDialogSize">
     <form name="form1" id="form1" method="post" action="/plugins/index.php?q=uploadimg&id=';echo $_REQUEST['id'];;echo '" enctype="multipart/form-data" target="myiframe">
     <tr> 
...
';}elseif ($s=="uploadannex"){;echo '<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" id="tabDialogSize">
     <form name="form1" id="form1" method="post" action="?';echo $query_site;echo '&q=plugins/uploadannex&id=';echo $_REQUEST['id'];;echo '" enctype="multipart/form-data" target="myiframe">
     <tr> 
