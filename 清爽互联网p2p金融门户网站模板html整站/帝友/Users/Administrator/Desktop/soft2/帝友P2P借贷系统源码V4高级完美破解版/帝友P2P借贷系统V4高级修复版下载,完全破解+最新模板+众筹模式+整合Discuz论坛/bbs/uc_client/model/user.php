...
class usermodel {
	...
	function add_user($username, $password, $email, $uid = 0, $questionid = '', $answer = '', $regip = '') {
		...
		//$this->db->query("INSERT INTO pre_common_member_status SET `uid`='".$uid."',`regip`='".$regip."',`lastip`='".$regip."',`lastvisit`='".$this->base->time."',`lastactivity`='".$this->base->time."',`lastpost`='0',`lastsendmail`='0'");
