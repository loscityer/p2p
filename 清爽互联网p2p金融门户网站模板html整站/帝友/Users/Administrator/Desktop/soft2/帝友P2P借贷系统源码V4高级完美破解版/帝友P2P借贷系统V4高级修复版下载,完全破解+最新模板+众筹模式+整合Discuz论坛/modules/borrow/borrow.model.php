...
$MsgInfo["right"] = "操作成功";
$MsgInfo["borrow_Second_er"] = "此标您已经投资过了，不能进行二次投标！";
$MsgInfo["borrow_Second_limit_money"] = "你投资金额大于了此标最大额度";
...
$MsgInfo["borrow_account_jin_credituse"] = "借款金额不能大于总资产的80%";
...
$MsgInfo["borrow_Seconds_no"] = "帐号余额不能小于借款所产生的利息";
$MsgInfo["borrow_Seconds_await_no"] = "只能有待收金额或满足一定代收额度才能投借款标";

$MsgInfo["borrow_flow_status"] = "你还未进行流转认证，不能发布流转标!";
...
$MsgInfo["borrow_is_flow_error"] = "流转标不能进行满标审核";
...
$MsgInfo["tender_money_no_h"] = "投资的金额大于了待借金额";
...
$MsgInfo["borrow_s_id_empty"] = "id不能为空";


$MsgInfo["articles_img_error"] = "上传缩略图格式错误";
$MsgInfo["articles_name_empty"] = "项目标题不能为空";
$MsgInfo["raise_period_empty"] = "项目期限不能为空";
$MsgInfo["raise_period_no"] = "项目期限必须大于0";
$MsgInfo["raise_account_no"] = "项目筹资金额必须大于0";
$MsgInfo["articles_id_empty"] = "项目id不能为空";
$MsgInfo["articles_not_exiest"] = "项目不存在";


$MsgInfo["borrow_raise_buy_error"] = "项目支持失败";
$MsgInfo["borrow_raise_paypassword_error"] = "支付密码错误";
$MsgInfo["borrow_raise_account_error"] = "余额不足，请充值！";
$MsgInfo["borrow_raise_buy_success"] = "支持成功,感谢您对该项目的支持！";
$MsgInfo["borrow_raise_end_time_error"] = "该项目已结束筹资!";
$MsgInfo["borrow_raise_account_j_error"] = "您想支持的金额大于了剩余筹资金额！";
?>
