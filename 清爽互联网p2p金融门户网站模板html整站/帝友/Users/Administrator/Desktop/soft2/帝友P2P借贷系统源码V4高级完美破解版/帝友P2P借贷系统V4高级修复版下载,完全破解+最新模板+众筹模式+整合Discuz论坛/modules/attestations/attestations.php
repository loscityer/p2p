...
$_A['list_purview']["attestations"]["name"] = "资料审核";
/* 屏蔽证明资料类型 hummer modify 201309081320
$_A['list_purview']["attestations"]["result"]["attestations_list"] = array("name"=>"证明资料类型","url"=>"code/attestations/list");
*/
$_A['list_purview']["attestations"]["result"]["attestations_upload"] = array("name"=>"资料审核","url"=>"code/attestations/upload");
$_A['list_purview']["attestations"]["result"]["attestations_uploads"] = array("name"=>"资料上传","url"=>"code/attestations/uploads");
