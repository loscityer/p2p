...
<head> 
<title>后台管理 - 吾爱源码 - bbs.52codes.net</title> 
...
<div id="header"> 
	<div class="logo" style="float:left; width:150px"> 
		...
		<div class="lun"> 
			<a href="index.php" target="_blank">网站首页</a>&nbsp;&#8211;&nbsp;<a href="">后台首页</a>
		</div> 
	</div> 
<!--重点导航--> 
  <ul class="nav" style="float:right"> 
<li><img src="/themes/youyidai_admin/images/nav_03.jpg" /></li>  
<li class="home"><a href="<? if (!isset($this->magic_vars['_A']['admin_url'])) $this->magic_vars['_A']['admin_url'] = ''; echo $this->magic_vars['_A']['admin_url']; ?>"  style="height:35px;display:block">管理首页</a></li>
...
<li id="other"><a style="cursor:pointer" href="#" onClick="return initguide('other');"  style="height:35px;display:block">新开发功能</a></li> 
<li id="other"></li> 
<li><img src="/themes/youyidai_admin/images/nav_07.jpg" /></li> 
<li><a style="cursor:pointer" target="_blank" href="http://bbs.52codes.net/">吾爱源码</a></li>  
...
function showtitle(){
	...
	if (cate && action && type) {
		...
		if (cate=='common') {
			html += '<div class="wei fl"><a href="'+admin_url+'">首页</a> &raquo; <a href="#" onclick="return initguide(cate,type,\'?admin\')">'+titles[action]+'</a> &raquo; <a href="#">'+guide[action][type][0]+'</a></div>';
		} else {
	...
	html += '<ul class="fr"><li class="home">欢迎您，用户名：'+admin_username+'('+admin_typename+')</li><li><a class="s0" style="cursor:pointer" onclick="parent.main.location.reload();" title="刷新主页面">刷新</a></li><li><a style="cursor:pointer" target="_blank" hr<li><a href="'+admin_url+'&q=logout">退出</a></li><a style="cursor:pointer" target="_blank" href="http://bbs.52codes.net/">吾爱源码</a></li></li></ul>';
