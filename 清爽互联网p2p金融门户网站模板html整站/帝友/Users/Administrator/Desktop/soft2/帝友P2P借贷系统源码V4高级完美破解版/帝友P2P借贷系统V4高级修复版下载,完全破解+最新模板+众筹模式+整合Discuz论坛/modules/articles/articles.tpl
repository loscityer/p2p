...
<div class="module_add">
	...
	<div style="float:right; width:30%;">
		...
		<div style="border:1px solid #CCCCCC; margin-bottom:10px ">
			...
			<div class="module_border">
				<div class="c">
					分类：<input type="checkbox" name="flag[]" value="index" align="absmiddle" {$_A.articles_result.flag|checked:"index"}/>首页 <input type="checkbox" name="flag[]" value="tuijian"  align="absmiddle" {$_A.articles_result.flag|checked:"tuijian"}/>推荐 <input type="checkbox" name="flag[]" value="ding"  align="absmiddle" {$_A.articles_result.flag|checked:"ding"}/>置顶
				</div>
			</div>
			<div class="module_border">
				<div class="c">
	...
	<div class="module_border">
		<div class="c" style="padding:10px 0">
			积分：{loop module="credit" function="GetTypeList" code="articles" limit="all" }
...
<div class="module_add">
	...
	<div style="float:left; width:30%;">
		...
		<div style="border:1px solid #CCCCCC; margin-bottom:10px ">
			...
			<div class="module_border">
				<div class="c">
					分&nbsp;&nbsp;类 ：<input type="checkbox" name="flag[]" value="index" align="absmiddle" {$_A.page_result.flag|checked:"index"}/>首页 <input type="checkbox" name="flag[]" value="tuijian"  align="absmiddle" {$_A.page_result.flag|checked:"tuijian"}/>推荐 <input type="checkbox" name="flag[]" value="ding"  align="absmiddle" {$_A.page_result.flag|checked:"ding"}/>置顶
				</div>
			</div>
			<div class="module_border">
				<div class="c">
			...
			<div class="module_border">
				<div class="c">
					发布时间：<input type="text" name="publish"  class="input_border" value="{ $_A.page_result.publish|default:"nowdate"}" size="30" onclick="change_picktime('yyyy-MM-dd HH:mm:ss')" readonly=""/>
				</div>
			</div>
			<div class="module_submit"><input type="button" value="确认提交" class="submit_button" name="save" onclick="submitForm()"/>
</div>
