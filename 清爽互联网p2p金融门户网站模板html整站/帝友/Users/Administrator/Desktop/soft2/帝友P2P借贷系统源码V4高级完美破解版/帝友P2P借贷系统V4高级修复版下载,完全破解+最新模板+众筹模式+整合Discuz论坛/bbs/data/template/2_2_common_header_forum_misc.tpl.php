...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1397472557, '2', './data/template/2_2_common_header_forum_misc.tpl.php', './template/singcere_note', 'common/header_forum_misc')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1397472557, '2', './data/template/2_2_common_header_forum_misc.tpl.php', './template/singcere_note', 'common/header_forum_misc')
;?>
