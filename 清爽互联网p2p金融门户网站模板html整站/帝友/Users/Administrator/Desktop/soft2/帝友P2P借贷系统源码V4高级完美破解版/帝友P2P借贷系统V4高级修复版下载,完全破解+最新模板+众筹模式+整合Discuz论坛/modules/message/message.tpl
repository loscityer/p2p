<ul class="nav3"> 
<li><a href="{$_A.query_url}">发送记录</a></li> 
<li><a href="{$_A.query_url}/receive">接收记录</a></li> 
<li><a href="{$_A.query_url}/new">发消息</a></li> 
</ul> 
...
<div class="module_add">
	<div class="module_add">
	<div class="module_title"><strong>短消息发送记录列表</strong></div>
	</div>
...
<table  border="0"  cellspacing="1" bgcolor="#CCCCCC" width="100%">
	...
	<tr>
	  ...
	  {/literal}
			...
			<div class="floatr">
				发送人：<input type="text" name="username" id="username" value="{$magic.request.username|urldecode}"/>  <input type="button" value="{$MsgInfo.users_name_sousuo}" / onclick="sousuo()">
			</div>
			</td>
		</tr>
	<tr align="center">
...
<div class="module_add">
	<div class="module_add">
	<div class="module_title"><strong>短消息接收记录列表</strong></div>
	</div>
	<form action="" method="post" id="form1">
<table  border="0"  cellspacing="1" bgcolor="#CCCCCC" width="100%">
	<tr >
	...
	<tr>
	  ...
	  {/literal}
			...
			<div class="floatr">
				接收人：<input type="text" name="username" id="username" value="{$magic.request.username|urldecode}"/>  <input type="button" value="{$MsgInfo.users_name_sousuo}" / onclick="sousuo()">
			</div>
			</td>
		</tr>
	<tr align="center">
