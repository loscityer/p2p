...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1397472512, '2', './data/template/2_2_common_header_home_magic.tpl.php', './template/singcere_note', 'common/header_home_magic')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1397472512, '2', './data/template/2_2_common_header_home_magic.tpl.php', './template/singcere_note', 'common/header_home_magic')
;?>
