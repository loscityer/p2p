...
<div class="module_add">
	...
	<div class="module_add">
	<div class="module_title"><strong>视频认证列表</strong></div>
	</div>
<table  border="0"  cellspacing="1" bgcolor="#CCCCCC" width="100%">
	...
	<tr {if $key%2==1} class="tr2"{/if}>
		...
		<td class="main_td1" align="center"><a href="javascript:void(0)" onclick='tipsWindown("视频认证人工审核","url:get?{$_A.query_url_all}&examine={$item.user_id}",500,230,"true","","false","text");'/>审核</a>/<a href="{$_A.query_url_all}&user_id={$item.user_id}&page={$magic.request.page}">修改</a></td>
	</tr>
	{/foreach}
	<tr>
