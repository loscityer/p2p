...
var aa = \'<select id="site_first" name="site_first"><option value="">请选择</option>';echo $_site_first;;echo '</select>&nbsp;<select id="site_center" name="site_center"><option value="">请选择</option>';echo $_site_center;;echo '</select>&nbsp;<select id="site_last" name="site_last" ';if ($_site_last==""){;echo 'style="display:none"';};echo '><option value="">请选择</option>';echo $_site_last;;echo '</select>\';
 document.write(aa); 
'; 
?> 