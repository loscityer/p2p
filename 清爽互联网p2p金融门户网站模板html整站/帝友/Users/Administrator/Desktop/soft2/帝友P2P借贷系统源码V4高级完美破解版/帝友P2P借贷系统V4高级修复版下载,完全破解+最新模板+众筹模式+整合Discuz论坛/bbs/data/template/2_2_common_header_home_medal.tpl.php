...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1397472909, '2', './data/template/2_2_common_header_home_medal.tpl.php', './template/singcere_note', 'common/header_home_medal')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1397472909, '2', './data/template/2_2_common_header_home_medal.tpl.php', './template/singcere_note', 'common/header_home_medal')
;?>
