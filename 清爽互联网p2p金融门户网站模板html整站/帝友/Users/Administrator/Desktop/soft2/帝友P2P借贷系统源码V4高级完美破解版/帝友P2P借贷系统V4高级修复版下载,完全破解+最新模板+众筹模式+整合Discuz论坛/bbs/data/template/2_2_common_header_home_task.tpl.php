...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1397472505, '2', './data/template/2_2_common_header_home_task.tpl.php', './template/singcere_note', 'common/header_home_task')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1397472505, '2', './data/template/2_2_common_header_home_task.tpl.php', './template/singcere_note', 'common/header_home_task')
;?>
