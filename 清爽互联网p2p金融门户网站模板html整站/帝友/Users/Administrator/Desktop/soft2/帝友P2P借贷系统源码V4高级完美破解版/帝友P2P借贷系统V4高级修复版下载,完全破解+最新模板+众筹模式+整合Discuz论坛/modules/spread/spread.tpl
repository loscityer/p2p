...
<ul class="nav3"> 
	<li><a href="{$_A.query_url_all}" id="c_so">建立推广</a></li>
	<li><a href="{$_A.query_url}/invitelog">邀请记录</a></li>
</ul>
...
<ul class="nav3"> 
	<li><a href="{$_A.query_url}/user" id="c_so">建立推广</a></li>
	<li><a href="{$_A.query_url_all}/invitelog">邀请记录</a></li>
</ul>
<table  border="0"  cellspacing="1" bgcolor="#CCCCCC" width="100%">
	<tr >
...
<ul class="nav3"> 
	<li><a href="{$_A.query_url_all}" id="c_so">总表</a></li>
	<li><a href="{$_A.query_url}/tender_month">月度表</a></li>
</ul>
<div class="module_add">
...
<ul class="nav3"> 
	<li><a href="{$_A.query_url}/tender" id="c_so">总表</a></li>
	<li><a href="{$_A.query_url}/tender_month">月度表</a></li>
</ul>
<div class="module_add">
...
<ul class="nav3"> 
	<li><a href="{$_A.query_url}/borrow" id="c_so">总表</a></li>
	<li><a href="{$_A.query_url}/borrow_month">月度表</a></li>
</ul>
<div class="module_add">
...
<ul class="nav3"> 
	<li><a href="{$_A.query_url_all}&type=1" id="c_so">投资推广</a></li>
	<li><a href="{$_A.query_url_all}&type=2">借款推广</a></li>
	<li><a href="{$_A.query_url_all}&type=3">审核推广</a></li>
