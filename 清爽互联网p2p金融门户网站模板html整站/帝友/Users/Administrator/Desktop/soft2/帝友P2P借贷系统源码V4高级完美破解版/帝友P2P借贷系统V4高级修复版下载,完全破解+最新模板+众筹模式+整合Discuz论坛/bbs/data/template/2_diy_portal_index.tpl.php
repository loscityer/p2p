...
0
|| checktplrefresh('./template/default/portal/index.htm', './template/singcere_note/common/header.htm', 1397552306, 'diy', './data/template/2_diy_portal_index.tpl.php', './template/singcere_note', 'portal/index')
|| checktplrefresh('./template/default/portal/index.htm', './template/singcere_note/common/footer.htm', 1397552306, 'diy', './data/template/2_diy_portal_index.tpl.php', './template/singcere_note', 'portal/index')
|| checktplrefresh('./template/default/portal/index.htm', './template/default/common/header_common.htm', 1397552306, 'diy', './data/template/2_diy_portal_index.tpl.php', './template/singcere_note', 'portal/index')
|| checktplrefresh('./template/default/portal/index.htm', './template/default/common/pubsearchform.htm', 1397552306, 'diy', './data/template/2_diy_portal_index.tpl.php', './template/singcere_note', 'portal/index')
;?>
