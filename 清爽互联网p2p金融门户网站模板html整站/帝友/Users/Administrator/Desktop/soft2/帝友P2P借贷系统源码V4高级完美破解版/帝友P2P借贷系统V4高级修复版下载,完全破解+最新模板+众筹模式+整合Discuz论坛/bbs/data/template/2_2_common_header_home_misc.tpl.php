...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1397552739, '2', './data/template/2_2_common_header_home_misc.tpl.php', './template/singcere_note', 'common/header_home_misc')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1397552739, '2', './data/template/2_2_common_header_home_misc.tpl.php', './template/singcere_note', 'common/header_home_misc')
;?>
