...
{else}
<ul class="nav3"> 
<li><a href="{$_A.query_url}/sms" id="c_so">手机认证</a></li> 
<li><a href="{$_A.query_url}/sms_log">发送记录</a></li> 
<li><a href="{$_A.query_url}/sms_set">手机设置</a></li> 
</ul> 
...
<table  border="0"  cellspacing="1" bgcolor="#CCCCCC" width="100%">
	...
	<tr>
	  ...
	  {/literal}
			...
			<div class="floatr">
				用户名：<input type="text" name="username" id="username" value="{$magic.request.username|urldecode}"/>  手机号：<input type="text" name="phone" id="phone" value="{$magic.request.phone}"/> 状态：{linkages nid="approve_status" name="status" value="$magic.request.status" default="审核全部" type="value"}   <input type="button" value="{$MsgInfo.users_name_sousuo}" / onclick="sousuo()">
			</div>
			</td>
		</tr>
	<tr align="center">
