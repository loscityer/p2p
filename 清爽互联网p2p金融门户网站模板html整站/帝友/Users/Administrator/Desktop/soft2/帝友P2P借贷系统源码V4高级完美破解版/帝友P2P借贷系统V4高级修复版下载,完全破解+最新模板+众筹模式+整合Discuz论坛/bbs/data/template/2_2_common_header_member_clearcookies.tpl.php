...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1397551816, '2', './data/template/2_2_common_header_member_clearcookies.tpl.php', './template/singcere_note', 'common/header_member_clearcookies')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1397551816, '2', './data/template/2_2_common_header_member_clearcookies.tpl.php', './template/singcere_note', 'common/header_member_clearcookies')
;?>
