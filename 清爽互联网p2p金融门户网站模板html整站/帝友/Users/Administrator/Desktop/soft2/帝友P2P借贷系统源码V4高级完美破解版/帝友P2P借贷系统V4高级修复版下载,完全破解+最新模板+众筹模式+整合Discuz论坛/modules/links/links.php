...
$_A['list_purview']["links"]["result"]["links_list"] = array("name"=>"友情链接列表","url"=>"code/links/list");
$_A['list_purview']["links"]["result"]["links_type"] = array("name"=>"友情链接列表","url"=>"code/links/type");
