...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1397551817, '2', './data/template/2_2_common_header_member_lostpasswd.tpl.php', './template/singcere_note', 'common/header_member_lostpasswd')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1397551817, '2', './data/template/2_2_common_header_member_lostpasswd.tpl.php', './template/singcere_note', 'common/header_member_lostpasswd')
;?>
