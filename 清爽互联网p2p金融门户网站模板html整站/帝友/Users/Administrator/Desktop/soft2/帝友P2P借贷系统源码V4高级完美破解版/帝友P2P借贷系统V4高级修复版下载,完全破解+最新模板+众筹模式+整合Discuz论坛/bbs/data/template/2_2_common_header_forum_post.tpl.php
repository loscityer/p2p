...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1397483178, '2', './data/template/2_2_common_header_forum_post.tpl.php', './template/singcere_note', 'common/header_forum_post')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1397483178, '2', './data/template/2_2_common_header_forum_post.tpl.php', './template/singcere_note', 'common/header_forum_post')
;?>
