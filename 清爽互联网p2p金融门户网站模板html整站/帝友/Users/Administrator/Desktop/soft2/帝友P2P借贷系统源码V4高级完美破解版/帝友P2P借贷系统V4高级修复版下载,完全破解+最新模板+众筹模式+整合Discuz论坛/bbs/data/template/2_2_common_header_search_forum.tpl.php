...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1397551761, '2', './data/template/2_2_common_header_search_forum.tpl.php', './template/singcere_note', 'common/header_search_forum')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1397551761, '2', './data/template/2_2_common_header_search_forum.tpl.php', './template/singcere_note', 'common/header_search_forum')
;?>
