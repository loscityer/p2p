...
<ul class="nav3"> 
<li><a href="{$_A.query_url_all}" id="c_so">所有转让</a></li> 
<li><a href="{$_A.query_url_all}&status=4">转让网站</a></li> 
<li><a href="{$_A.query_url_all}&status=2">正在转让</a></li> 
<li><a href="{$_A.query_url_all}&status=5">撤销</a></li> 
<li><a href="{$_A.query_url_all}&status=1">转让成功</a></li>  
...
<table  border="0"  cellspacing="1" bgcolor="#CCCCCC" width="100%">
	  <form action="" method="post">
		...
		{/if}
		{if $magic.request.status==1 and $magic.request.web==1}
			收益总计：{$loop.shouyi|default:0.00}元
		{/if}
		</div>
		<div class="floatr">
		{if $magic.request.status==1 and $magic.request.web==1}
