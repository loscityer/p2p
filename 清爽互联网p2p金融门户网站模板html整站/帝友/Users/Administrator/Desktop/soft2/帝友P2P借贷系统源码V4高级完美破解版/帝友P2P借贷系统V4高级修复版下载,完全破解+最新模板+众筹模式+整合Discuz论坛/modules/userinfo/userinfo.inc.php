...
if (isset($_POST['type']) && $_POST['type'] ==1){
	...
	elseif ($_U['query_type'] == "schoolinfo"){
		$var = array("school","ruxue_time","xuehao","zhuanye","banji","sushe","sushe_tel");	
		$_msg = "学校信息修改成功";
		$_url = "list";
	}
	

	elseif ($_U['query_type'] == "schooledu"){
		$var = array("banzhuren","banzhuren_tel","banzhang","banzhang_tel","tongxue1","tongxue1_tel","tongxue2","tongxue2_tel","tongxue3","tongxue3_tel");	
		$_msg = "学校关系修改成功";
		$_url = "list";
	}
