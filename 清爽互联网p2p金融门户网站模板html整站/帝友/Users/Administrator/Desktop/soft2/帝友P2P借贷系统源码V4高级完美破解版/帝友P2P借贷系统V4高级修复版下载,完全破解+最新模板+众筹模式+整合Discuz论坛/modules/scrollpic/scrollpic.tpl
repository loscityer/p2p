...
<div class="module_add">
	...
	<div class="module_border">
		...
		<div class="c">
			<input type="file" name="pic"  class="input_border" size="20" /> 高340，宽>1440 {if $_A.scrollpic_result.pic!=""}<a href="./{$_A.scrollpic_result.pic}" target="_blank" title="有图片"><img src="{ $tpldir }/images/ico_1.jpg" border="0"  /></a>{/if}
		</div>
	</div>
