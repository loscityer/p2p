...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1397472551, '2', './data/template/2_2_common_header_forum_guide.tpl.php', './template/singcere_note', 'common/header_forum_guide')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1397472551, '2', './data/template/2_2_common_header_forum_guide.tpl.php', './template/singcere_note', 'common/header_forum_guide')
;?>
