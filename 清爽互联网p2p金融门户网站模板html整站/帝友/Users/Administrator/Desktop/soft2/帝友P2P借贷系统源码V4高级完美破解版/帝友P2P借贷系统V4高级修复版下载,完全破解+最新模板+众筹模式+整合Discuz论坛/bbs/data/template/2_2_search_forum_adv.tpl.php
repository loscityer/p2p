...
0
|| checktplrefresh('./template/default/search/forum_adv.htm', './template/default/search/pubsearch.htm', 1397551833, '2', './data/template/2_2_search_forum_adv.tpl.php', './template/singcere_note', 'search/forum_adv')
...
<?php } ?><?php $policymsgs = $p = '';?><?php if(is_array($_G['setting']['creditspolicy']['search'])) foreach($_G['setting']['creditspolicy']['search'] as $id => $policy) { ?><?php
$policymsg = <<<EOF
