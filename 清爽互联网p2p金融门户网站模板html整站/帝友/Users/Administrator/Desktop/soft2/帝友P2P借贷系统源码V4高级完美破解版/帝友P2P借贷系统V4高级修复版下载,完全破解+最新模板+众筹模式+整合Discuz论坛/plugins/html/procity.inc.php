...
var aa = \'<select id="province" name="province"><option value="">请选择</option>';echo $_province;;echo '</select>&nbsp;<select id="city" name="city" ';if ($_city==""){;echo 'style="display:none"';};echo '>';echo $_city;;echo '</select>&nbsp;<select id="area" name="area" ';if ($_area==""){;echo 'style="display:none"';};echo '>';echo $_area;;echo '</select>\';
 document.write(aa); 
'; 
?> 