...
?>
	...
	<div class="module_border">
		...
		<div class="c">
			<input type="file" name="pic"  class="input_border" size="20" /> 高340，宽>1440 <? if (!isset($this->magic_vars['_A']['scrollpic_result']['pic'])) $this->magic_vars['_A']['scrollpic_result']['pic']=''; ;if (  $this->magic_vars['_A']['scrollpic_result']['pic']!=""): ?><a href="./<? if (!isset($this->magic_vars['_A']['scrollpic_result']['pic'])) $this->magic_vars['_A']['scrollpic_result']['pic'] = ''; echo $this->magic_vars['_A']['scrollpic_result']['pic']; ?>" target="_blank" title="有图片"><img src="<? if (!isset($this->magic_vars['tpldir'])) $this->magic_vars['tpldir'] = ''; echo $this->magic_vars['tpldir']; ?>/images/ico_1.jpg" border="0"  /></a><? endif; ?>
		</div>
	</div>
...
<table  border="0"  cellspacing="1" bgcolor="#CCCCCC" width="100%">
  <form action="<? if (!isset($this->magic_vars['_A']['query_url'])) $this->magic_vars['_A']['query_url'] = ''; echo $this->magic_vars['_A']['query_url']; ?>/order" method="post">
	...
	<? $this->magic_vars['query_type']='GetList';$data = array('var'=>'loop');$data['page'] = intval(isset($_REQUEST['page'])?$_REQUEST['page']:'');  require_once(ROOT_PATH.'modules/scrollpic/scrollpic.class.php');$this->magic_vars['magic_result'] = scrollpicClass::GetList($data); $this->magic_vars['loop']=  $this->magic_vars['magic_result']; $this->magic_vars['loop']['list'] =  $this->magic_vars['magic_result']['list']; $this->magic_vars['loop']['page'] =  intval($this->magic_vars['magic_result']['page']); $this->magic_vars['loop']['epage'] =  $this->magic_vars['magic_result']['epage']; $this->magic_vars['loop']['total'] =  $this->magic_vars['magic_result']['total']; $this->magic_vars['loop']['pages'] =  array('total'=>$this->magic_vars['magic_result']['total'],'page'=>$this->magic_vars['magic_result']['page'],'epage'=>$this->magic_vars['magic_result']['epage']);?>
