...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1397552283, '2', './data/template/2_2_common_header.tpl.php', './template/singcere_note', 'common/header')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1397552283, '2', './data/template/2_2_common_header.tpl.php', './template/singcere_note', 'common/header')
;?>
