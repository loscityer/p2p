...
<ul class="nav3"> 
<li><a href="{$_A.query_url_all}" id="c_so">所有圈子</a></li> 
<li><a href="{$_A.query_url_all}&status=0">待审核</a></li> 
<li><a href="{$_A.query_url_all}&status=1">已审核</a></li> 
<li><a href="{$_A.query_url_all}&status=2">不通过</a></li> 
<li><a href="{$_A.query_url_all}&action=new">添加圈子</a></li> 
</ul> 
...
<ul class="nav3"> 
<li><a href="{$_A.query_url_all}" id="c_so">所有话题</a></li> 
<li><a href="{$_A.query_url_all}&status=0">待审核</a></li> 
<li><a href="{$_A.query_url_all}&status=1">已通过</a></li> 
<li><a href="{$_A.query_url_all}&status=2">不通过</a></li> 
<li><a href="{$_A.query_url_all}&status=3">关闭</a></li> 
<li><a href="{$_A.query_url_all}&action=new">添加话题</a></li> 
</ul> 
<div class="module_add">
...
<ul class="nav3"> 
<li><a href="{$_A.query_url_all}" id="c_so">所有成员</a></li> 
<li><a href="{$_A.query_url_all}&status=0">申请中</a></li> 
<li><a href="{$_A.query_url_all}&status=1">已通过</a></li> 
<li><a href="{$_A.query_url_all}&status=2">不通过</a></li> 
<li><a href="{$_A.query_url_all}&status=3">关闭</a></li> 
<li><a href="{$_A.query_url_all}&status=4">退出</a></li> 
</ul> 
<div class="module_add">
...
<ul class="nav3"> 
<li><a href="{$_A.query_url_all}" id="c_so">所有评论</a></li> 
<li><a href="{$_A.query_url_all}&status=1">已通过</a></li> 
<li><a href="{$_A.query_url_all}&status=2">不通过</a></li> 
<li><a href="{$_A.query_url_all}&status=0">待审核</a></li> 
<li><a href="{$_A.query_url_all}&status=3">关闭</a></li> 
