...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1397553209, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/singcere_note', 'common/header_forum_index')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1397553209, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/singcere_note', 'common/header_forum_index')
;?>
