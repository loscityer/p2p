...
0
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/singcere_note/common/header.htm', 1397542767, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/singcere_note', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1397542767, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/singcere_note', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1397542767, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/singcere_note', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/singcere_note/forum/forumdisplay_list.htm', 1397542767, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/singcere_note', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1397542767, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/singcere_note', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/singcere_note/common/footer.htm', 1397542767, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/singcere_note', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/common/header_common.htm', 1397542767, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/singcere_note', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/common/pubsearchform.htm', 1397542767, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/singcere_note', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1397542767, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/singcere_note', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1397542767, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/singcere_note', 'forum/forumdisplay')
;?>
...
<ul id="waterfall" class="ml waterfall cl"><?php if(is_array($_G['forum_threadlist'])) foreach($_G['forum_threadlist'] as $key => $thread) { if(!$thread['forumstick'] && ($thread['isgroup'] == 1 || $thread['fid'] != $_G['fid'])) { if($thread['related_group'] == 0 && $thread['closed'] > 1) { ?><?php $thread[tid]=$thread[closed];?><?php } } ?><?php $waterfallwidth = $_G[setting][forumpicstyle][thumbwidth] + 24;?><li style="width:<?php echo $waterfallwidth;?>px;">
<?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?>
...
<?php if($_G['setting']['threadmaxpages'] > 1 && $page && !$subforumonly && $page < $_G['setting']['threadmaxpages'] && $page < $_G['page_next']) { ?><?php $nxtpage = $page + 1;?><div class="bm bw0 pgs cl">
