...
<div class="module_add">
	...
	<div class="module_border">
		...
		<div class="c">
			<input type="file" name="logoimg"  class="input_border" size="20" />{if $_A.links_result.logoimg!=""}<a href="./{$_A.links_result.fileurl}" target="_blank" title="有图片"><img src="./{$_A.links_result.fileurl}" border="0" width="40" height="40"  /></a>{/if}
		</div>
	</div>
