...
var aa = \'<select id="school_province" name="school_province"><option value="">请选择</option>';echo $_province;;echo '</select>&nbsp;<select id="school_city" name="school_city" ';if ($_city==""){;echo 'style="display:none"';};echo '>';echo $_city;;echo '</select>\';
 document.write(aa); 
'; 
?>