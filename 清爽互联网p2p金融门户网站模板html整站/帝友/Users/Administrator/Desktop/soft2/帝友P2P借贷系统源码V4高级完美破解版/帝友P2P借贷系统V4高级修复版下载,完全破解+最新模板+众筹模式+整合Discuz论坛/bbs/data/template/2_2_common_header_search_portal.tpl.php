...
0
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/header_common.htm', 1397551967, '2', './data/template/2_2_common_header_search_portal.tpl.php', './template/singcere_note', 'common/header_search_portal')
|| checktplrefresh('./template/singcere_note/common/header.htm', './template/default/common/pubsearchform.htm', 1397551967, '2', './data/template/2_2_common_header_search_portal.tpl.php', './template/singcere_note', 'common/header_search_portal')
;?>
