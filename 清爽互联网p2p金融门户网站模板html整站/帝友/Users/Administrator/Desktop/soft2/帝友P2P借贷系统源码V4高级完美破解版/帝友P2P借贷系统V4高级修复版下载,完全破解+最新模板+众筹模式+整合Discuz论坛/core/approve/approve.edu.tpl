...
{else}
<ul class="nav3"> 
<li><a href="{$_A.query_url}/edu" id="c_so">学历认证</a></li> 
<li><a href="{$_A.query_url}/edu_id5">认证记录</a></li> 
</ul> 

{if $_A.query_type=="edu_id5"}
<div class="module_add">
	<div class="module_title"><strong>认证记录列表</strong></div>
	</div>
...
<div class="module_add">
	...
	<div class="l">学历证件：</div>
		<div class="c">
			<input type="file" name="edu_pic" style=" width:200px"/>{if $_A.approve_result.edu_pic!=""}<a href="./{ $_A.approve_result.edu_pic_url}" target="_blank" title="有图片"><img src="{ $_A.tpldir  }/images/ico_yes.gif" border="0"  /></a>{/if}
		</div>
	</div>
	...
	<div class="module_add">
	<div class="module_title"><strong>学历认证列表</strong></div>
	</div>
<table  border="0"  cellspacing="1" bgcolor="#CCCCCC" width="100%">
	<tr >
		<td width="" class="main_td">用户</td>
